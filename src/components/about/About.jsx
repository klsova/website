  ...
  return (
    <div className='about-container'>
      <div id="about" className="about">
        ...
        <p>In my freetime I enjoy running, videogames, television shows and programming of course. I enjoy taking on new challenges and learning something new, which probably where my love and passion from coding stems from.</p>
      </div>
    </div>
  );
}
